...
```
The search will return all cloud and client-side metrics generated by AWS IoT Device Defender and will prove that the data is being ingested into the chosen index.
...
![Displaying open TCP ports on device](images/splunk_dashboard_step_1.png)
